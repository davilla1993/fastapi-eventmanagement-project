...
async def create_category(
    ...
    return await CreateCategoryUseCase(repo, uow, audit).execute(body, current_user.public_id)
...
async def update_category(
    ...
    uow = UnitOfWork(db)
    audit = AuditService(db)
    return await UpdateCategoryUseCase(repo, uow, audit).execute(
...
async def delete_category(
    ...
    uow = UnitOfWork(db)
    audit = AuditService(db)
    await DeleteCategoryUseCase(repo, uow, audit).execute(public_id, current_user.public_id)